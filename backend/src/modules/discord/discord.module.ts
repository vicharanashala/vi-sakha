...
import {
  QaProposal,
  QaProposalSchema,
} from '../rag/qa-proposals/schemas/qa-proposal.schema';
...
import { EmbeddingWorkerModule } from '../rag/embedding-worker/embedding-worker.module';
import { McpModule } from '../rag/mcp/mcp.module';
...
@Module({
  controllers: [DiscordController, DiscordBotController],
  imports: [
    ConfigModule,
    HttpModule,
