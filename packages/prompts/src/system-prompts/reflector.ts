 ...
 *
 * Evaluates draft responses for quality, accuracy, and completeness.
 * Can trigger a retry loop (max 2 iterations) if quality is insufficient.
 */

export const REFLECTOR_SYSTEM_PROMPT = `<ROLE>
